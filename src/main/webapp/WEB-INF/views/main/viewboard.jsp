...
<head>
	...
	<title>메이킹보고나서 엔딩 볼수있을거 같아서 네캐 들어갔는데 ㅠㅠ - 호텔 델루나 갤러리</title>
	...
	<div class="area_links"> 
	  <ul> 
		...
		<li><a href="https://event.dcinside.com">이벤트</a></li>
		 <li><a class="btn_top_loginout" href="https://dcid.dcinside.com/join/login.php?s_url=https%3A%2F%2Fgall.dcinside.com%2Fboard%2Fview%2F%3Fid%3Dhoteltvn%26no%3D111342%26page%3D1&s_key=403">로그인</a></li>		
	  </ul>
	</div>
  </div>
</header> 
    ...
    <div class="gnb_bar">
      <nav class="gnb clear">
        ...
        <ul class="gnb_list clear">
          ...
          <li><a href="//gall.dcinside.com/m" class="link_gnb " url_code="mgallery">m.갤러리</a></li>
	  ...
	  <div class="view_block_setting">
		...
		<div class="inner">
		  <div class="set_cont" >
			...
			<button type="button" class="btn_enroll" onclick="ub_save_conf_one('hoteltvn','호텔 델루나','nick',$('#bword').val())">등록</button>
		  </div>
		  
		  		  <div class="set_cont">
			<label for="bip" class="cont_tit">차단 IP</label>
			<input type="text" id="bip" title="차단 IP 입력" class="intxt" value="58.122">
			<button type="button" class="btn_enroll" onclick="ub_save_conf_one('hoteltvn','호텔 델루나','ip',$('#bip').val())">등록</button>
		  </div>
...
lately_gall_init('hoteltvn', '호텔 델루나', '');
		...
		<article>
			<form name="frm">
				<input type="hidden" id="view_url" name="view_url" value="https://gall.dcinside.com/board?id=hoteltvn&no=111342page=">
				...
				<input type="hidden" id="id" name="gallery_id" value="hoteltvn">
				<input type="hidden" id="gallery_id" name="gallery_id" value="hoteltvn">
				<input type="hidden" id="no" name="gallery_no" value="111342">
			...
			<div class="view_content_wrap">
				<header>
					<div class="gallview_head clear ub-content">
						...
						<h3 class="title ub-word"><span class="title_headtext"></span> <span class="title_subject">메이킹보고나서 엔딩 볼수있을거 같아서 네캐 들어갔는데 ㅠㅠ</span><span class="title_device"></span></h3>
						<div class="gall_writer ub-writer" data-nick="ㅇㅇ" data-uid="" data-ip="58.122" data-loc="view">
							<div class="fl">
								<span class='nickname' title='ㅇㅇ'><em>ㅇㅇ</em></span><span class="ip">(58.122)</span></span>								<span class="gall_date" title="2019-09-04 14:38:26">2019.09.04 14:38:26</span>
							</div>
							<div class="fr">
								<span class="gall_count">조회 13</span>
				...
				<div class="gallview_contents">
					<div class="inner clear">
						<div class="writing_view_box">
							<div id="zzbang_div" style="display:none" ><span id='zzbang_ad'><script type="text/javascript" src="https://addc.dcinside.com/NetInsight/text/dcinside/gallery/auto@tv"></script></span></div><pre></pre><div id='taboola-above-article-thumbnails'></div><br>
							<script type='text/javascript'>
			  					window._taboola = window._taboola || [];
			  					_taboola.push({
							...
							<p>그리고 나는 당신과의 약속을 기억합니다 하고 bgm나오는데 벌써 눈물 나올거 같아서</p><p><br></p><p>걍 꺼버림 ㅠㅠㅠㅠㅠㅠ 아 언제쯤 엔딩 다시 볼수있으려나 ㅋㅋㅋ</p><p><br></p><p><br></p><p>네캐 죽돌이였는데 이번주꺼 왜이리 보기 힘드냐 ㅠㅠ</p><p><br></p><p><br></p>								</div>
						</div>
						<!--  본문 우측 광고 -->
...
<script>
  googletag.cmd.push(function() {
    googletag.defineSlot('/76378310/body_right_160600', [160, 600], 'div-gpt-ad-1524708955258-0').addService(googletag.pubads());
    googletag.pubads().enableSingleRequest();
    googletag.enableServices();
  });
</script>

<!-- /76378310/body_right_160600 -->
<div id='div-gpt-ad-1524708955258-0' style='height:600px; width:160px;'>
<script>
googletag.cmd.push(function() { googletag.display('div-gpt-ad-1524708955258-0'); });
</script>
</div>
</div>						<!--  //본문 우측 광고 -->
					</div>
					<!-- 추천검색-->
					<div id="sch_alliance_box_111342" class="sch_alliance_box clear" style="display: none">
						<div class="fl">
							<span class="sch_alliance">추천검색</span>
						</div>
						<div id="sch_logbox_111342" class="fl sch_logbox"></div>
					</div>
					<!-- //추천검색-->
					<!-- //추천캡차-->
						                					<!-- 추천 비추천 -->
					<div class="btn_recommend_box clear">
						...
						<div class="inner fl">
							<div class="up_num_box">
								<p class="up_num font_red" id="recommend_view_up_111342">0</p>
								<p class="sup_num">
									<spen class="writer_nikcon">
                						<img src="//nstatic.dcinside.com/dc/w/images/fix_nik.gif" alt="고정닉">
            						</spen>
									<span class="font_blue smallnum" id="recommend_view_up_fix_111342">0</span>
								</p>
							</div>
							<button type="button" class="btn_recom_up" data-no="111342"><span class="blind">개념 추천</span><em class="sp_img icon_recom_up"></em></button>
						</div>
						<div class="inner fr">
							<button type="button" class="btn_recom_down" data-no="111342"><span class="blind">개념 비추천</span><em class="sp_img icon_recom_down"></em></button>
							<div class="down_num_box">
								<p class="down_num" id="recommend_view_down_111342">0</p>
							</div>
						</div>
						<div class="recom_bottom_box clear">
							<button type="button" class="btn_hitgall" data-no="111342"><em class="sp_img icon_hitgall"></em>힛추</button>
							<button type="button" class="btn_snsmore" data-no="111342"><em class="sp_img icon_snsmore"></em>공유</button>
							<button type="button" class="btn_report" data-no="111342"><em class="sp_img icon_report"></em>신고</button>
						</div>
					</div>
					<!-- //추천 비추천 -->
										<!-- 본문 하단 광고 -->
...
<script>
  googletag.cmd.push(function() {
    googletag.defineSlot('/76378310/body_shop_980120', [980, 120], 'div-gpt-ad-1533028048183-0').addService(googletag.pubads());
    googletag.pubads().enableSingleRequest();
    googletag.enableServices();
  });
</script>
<!-- /76378310/body_shop_980120 -->
<div id='div-gpt-ad-1533028048183-0' style='height:120px; width:980px;margin:auto;'>
<script>
googletag.cmd.push(function() { googletag.display('div-gpt-ad-1533028048183-0'); });
</script>
</div></div>					<!-- //본문 하단 광고 -->
									</div>
			</div>
...
<div class="view_comment">
	...
	<div id="comment_wrap_111342" class="comment_wrap" data-article-lv="10" data-sort-type='I'>
		<div class="comment_count">
			<div class="fl num_box">
				전체 리플 <em class="font_red"><span id="comment_total_111342">0</span></em>개
				<div class="select_box array_latest">
					...
					<div class="select_area" onClick="showLayer(this, 'commentSortLayer_111342');return false;"><span class="comment_sort_txt">등록순</span><span class="blind">정렬 기준선택</span><em class="sp_img icon_option_more"></em></div>
					<ul class="option_box" id="commentSortLayer_111342" data-no="111342" style="left:-1px;top:19px;display:none">
			...
			<div class="fr">
				<button type="button" class="btn_cmt_close" data-no="111342" data-loc="TOP"><span>댓글닫기</span><em class="sp_img icon_cmt_more"></em></button>
				<button type="button" class="btn_cmt_refresh" data-no="111342" data-sort="">새로고침</button>
			</div>
		</div>
	</div>
...
<input type="hidden" name="gallery_no" id="gallery_no" value="23436" />

<input type="hidden" name="clickbutton" id="clickbutton" value="N" />

<input type='hidden' name='check_6' id='check_6' value='a67424aa1806b544b73405619c02e4b687ec99fd8ecd1f6227b1037d4902188f2c8b388adefe2021890fba663b02dcf34ee56ddc92085660c1a7d012651fe3bf5f6bca97dfe5e6bbfa994a61a9e48e8d820ce92b' />
<input type='hidden' name='check_7' id='check_7' value='7d' />
<input type='hidden' name='check_8' id='check_8' value='ae5837a50035' />
<input type='hidden' name='check_9' id='check_9' value='78e59e77b78076f43fee98e14e' />

<input type="hidden" id="cur_t" name="cur_t" value="1567575538">
<input type="hidden" id="user_ip" name="user_ip" value="58.149.46.252">
<input type="hidden" name="ehqo_C" id="ehqo_C" value="spam_key"/>
<input type="hidden" name="spam_key" id="spam_key" value="rhkdrhgkwlak!!"/>
<input type="hidden" name="e08880180e28704304c464d2dc633879033e11e061521a9a5c414e95c5b1fc86d6541329210dda116caa4bf45503c161" id="e08880180e28704304c464d2dc633879033e11e061521a9a5c414e95c5b1fc86d6541329210dda116caa4bf45503c161" value="b9d2c24a576b33184b80299fd868227a1eb9d7bb770aca84ee40b5b3a870ec7bc459c6e114644d7d603ae165d3a2b300"/>
<input type='hidden' name="service_code" value=""/>
<div class="cmt_write_box clear">
	<div class="fl">
				<div class="user_info_input">
			<label for="user_nick" class="blind">닉네임</label>
			<input type="text" id="name_111342" name = "name" placeholder="닉네임" onfocus="this.style.background='#FFFFFF'" maxlength="20" value="">
		</div>
		<div class="user_info_input">
			<label for="user_pw" class="blind">비밀번호</label>
			<input type="password" id="password_111342" name = "password" placeholder="비밀번호" onfocus="this.style.background='#FFFFFF'" maxlength = "20">
		</div>
					</div>
	<div class="cmt_txt_cont">
		<div class="cmt_write">
			...
			<textarea id="memo_111342" onfocus="$('.cmt_textarea_label').hide();" maxlength="400" onKeyup="javascript:reply_length_count(111342);"></textarea>
		</div>
		<div class="cmt_cont_bottm clear">
			 <div class="dccon_guidebox">
				<button type="button" class="btn_white small tx_dccon" data-no = '111342'><em class="sp_img icon_dccon"></em>디시콘</button>
				<button type="button" class="btn_dccon_guide">
				<span class="blind">디시콘이란</span><em class="sp_img icon_guide_open"></em>
				</button>
			</div>
			<div class="fr">
				<button type="button" class="btn_blue btn_svc small repley_add" data-no = "111342">등록</button>
				<button type="button" class="btn_lightblue btn_svc small repley_add_vote" data-no = "111342">등록+추천</button>
			</div>
		</div>
	</div>
</div>
...
<script type="text/javascript">
var _r = _d('QgnHPM06QTw5PM0wR/uvdMyDdTu4QgQtQFWFPMQud4u4d+QtQ+y5PMq4P+UK');
$(document).data('t_vch2', '');
$(document).data('gallery_id', 'hoteltvn');
$(document).data('article_no', '111342');
$(document).data('comment_id', 'hoteltvn');
$(document).data('comment_no', '111342');
viewComments(1, 'VIEW_PAGE');
	...
	<div class="fr">
					<button type="button" class="btn_grey modify" onclick="goModify('https://gall.dcinside.com/board/modify/?id=hoteltvn&no=111342')">수정</button>
							<button type="button" class="btn_grey cancle" onclick="goDelete('https://gall.dcinside.com/board/delete/?id=hoteltvn&no=111342')">삭제</button>
...
<div>
  ...
  <div id="login_box" class="login_box">
	<div class="user_info" data-alarmId="">
	  <strong onclick="location='https://dcid.dcinside.com/join/login.php?s_url=https%3A%2F%2Fgall.dcinside.com%2Fboard%2Fview%2F%3Fid%3Dhoteltvn%26no%3D111342%26page%3D1&s_key=403'" style="cursor:pointer">로그인을 해 주시기 바랍니다.</strong> 
	</div>
  ...
  <!-- //로그인 정보 -->
	...
	<article>
	  <div class="content_box r_sec_recommend">
		<header >
		  <h3 class="tit"><a href="/board/lists/?id=superidea">초개념</a></h3>
		  <button type="button" class="btn_more" onclick="location.href='/board/lists/?id=superidea'">
			<span class="blind">초개념 더보기</span><em class="sp_img icon_more"></em>
		  </button>
		</header>
		<div id="rightToprecom" class="rcont_sec">
		  <div class="img">
		  
			<script id="gr_toprecom-thumb-tmpl" type="text/x-jquery-tmpl">
			<div class="secimg_box">
			  <a class="inner logClass" href="${url}" depth1="rightframe" depth2="toprecommend">
				<span class="img_box">
				  <img src="${thumb}" alt="" style="position:relative; ${thumb_css}">
				</span>
				<div class="txt_box">
				  <strong>${title}</strong>
				</div>
		  ...
		  <ul class="txt"></ul>
		  <script id="gr_toprecom-txt-tmpl" type="text/x-jquery-tmpl">
		...
		<li><button type="button" class="img_dccon" detail_idx="${idx}" package_idx="${package_idx}" title="${title}"><img src="${list_img}" alt="${title}"></button></li>
			...
			<div class="dccon_list_box hot" style="display:none">
			  <div class="box layer_dccon_info" style="display:block">
				...
				<button class="btn_blue small" onclick="window.open('https://mall.dcinside.com/?from=A08&url=https%3A%2F%2Fdccon.dcinside.com')" >디시콘 더보기</button>
