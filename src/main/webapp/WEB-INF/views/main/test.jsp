						...
						<header>
							<div class="gallview_head clear ub-content">
									...
									<h3 class="title ub-word">
										<span class="title_subject">${board.getTitle() }</span><em
											class="blind">${board.getAppro() }</em><em
											class="sp_img icon_write_mbl"></em>
									</h3>
									<div class="gall_writer ub-writer">
										<div class="fl">
											<span class='nickname'>${board.getNick()}</span><span
												class="gall_date">${board.getDate() }</span>
										</div>
										<div class="fr">
											<span class="gall_count">조회 ${board.getInqu() }</span> <span
												class="gall_reply_num">추천 ${board.getReco() }</span> <span
												class="gall_comment">댓글 ${board.getRepnum()}</span>
										</div>
									</div>
							</div>
						</header>
